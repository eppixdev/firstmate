...
description: >-
  ...
  Covers home leases, transactional seeding, no-mistakes gate repair, project clone restrictions, secondmate harness pins, inherited config push, idle charter, handoff helper, and teardown safety.
